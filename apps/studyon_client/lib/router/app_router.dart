...
import '../features/student/weekly_review/weekly_review_screen.dart';
import '../features/student/plan/plan_screen.dart';
import '../features/student/goal_roadmap/goal_roadmap_screen.dart';
import '../features/student/daily_mission/daily_mission_screen.dart';
...
import '../features/student/motivation/motivation_settings_screen.dart';
  ...
  routes: [
    GoRoute(
      ...
      pageBuilder: (context, state) =>
          _noTransition(const SplashScreen(), state),
    ),
    GoRoute(
      path: '/onboarding',
      pageBuilder: (context, state) =>
          _noTransition(const OnboardingScreen(), state),
    ),
    GoRoute(
      path: '/login',
      pageBuilder: (context, state) =>
          _noTransition(const LoginScreen(), state),
    ),
    GoRoute(
      path: '/signup',
      pageBuilder: (context, state) =>
          _noTransition(const SignupScreen(), state),
    ),
    GoRoute(
      path: '/student/checkin',
      pageBuilder: (context, state) =>
          _noTransition(const CheckInScreen(), state),
    ),
    ...
    ShellRoute(
      ...
      routes: [
        GoRoute(
          path: '/student/home',
          pageBuilder: (context, state) =>
              _noTransition(const HomeScreen(), state),
        ),
        GoRoute(
          path: '/student/records',
          pageBuilder: (context, state) =>
              _noTransition(const RecordsScreen(), state),
        ),
        GoRoute(
          path: '/student/rankings',
          pageBuilder: (context, state) =>
              _noTransition(const RankingsScreen(), state),
        ),
        GoRoute(
    ...
    GoRoute(
      ...
      pageBuilder: (context, state) =>
          _noTransition(const StudySessionScreen(), state),
    ),
    GoRoute(
      path: '/student/summary',
      pageBuilder: (context, state) => _noTransition(
        StudySummaryScreen(
          reward: (state.extra as Map?)?.cast<String, dynamic>(),
        ),
        state,
      ),
    ),
    GoRoute(
      ...
      pageBuilder: (context, state) =>
          _noTransition(const WeeklyReviewScreen(), state),
    ),
    GoRoute(
      path: '/student/plan',
      pageBuilder: (context, state) => _noTransition(const PlanScreen(), state),
    ),
    GoRoute(
      path: '/student/goal-roadmap',
      pageBuilder: (context, state) =>
          _noTransition(const GoalRoadmapScreen(), state),
    ),
    GoRoute(
      path: '/student/daily-mission',
      pageBuilder: (context, state) =>
          _noTransition(const DailyMissionScreen(), state),
    ),
    GoRoute(
      path: '/student/seats',
      pageBuilder: (context, state) =>
          _noTransition(const StudentSeatsScreen(), state),
    ),
    GoRoute(
      path: '/student/notifications',
      pageBuilder: (context, state) =>
          _noTransition(const StudentNotificationsScreen(), state),
    ),
    GoRoute(
      path: '/student/points',
      pageBuilder: (context, state) =>
          _noTransition(const PointsScreen(), state),
    ),
    GoRoute(
      path: '/student/character',
      pageBuilder: (context, state) =>
          _noTransition(const CharacterScreen(), state),
    ),
    GoRoute(
      path: '/student/motivation-settings',
      pageBuilder: (context, state) =>
          _noTransition(const MotivationSettingsScreen(), state),
    ),
    ...
    ShellRoute(
      ...
      routes: [
        GoRoute(
          ...
          pageBuilder: (context, state) =>
              _noTransition(const DashboardScreen(), state),
        ),
        GoRoute(
          path: '/admin/seats',
          pageBuilder: (context, state) =>
              _noTransition(const SeatsScreen(), state),
        ),
        GoRoute(
          path: '/admin/students',
          pageBuilder: (context, state) =>
              _noTransition(const StudentsScreen(), state),
        ),
        GoRoute(
        ...
        GoRoute(
          ...
          pageBuilder: (context, state) =>
              _noTransition(const StudentFormScreen(), state),
        ),
        GoRoute(
        ...
        GoRoute(
          path: '/admin/rankings',
          pageBuilder: (context, state) =>
              _noTransition(const AdminRankingsScreen(), state),
        ),
        GoRoute(
          path: '/admin/study-overview',
          pageBuilder: (context, state) =>
              _noTransition(const StudyOverviewScreen(), state),
        ),
        GoRoute(
          path: '/admin/attendance',
          pageBuilder: (context, state) =>
              _noTransition(const AdminAttendanceScreen(), state),
        ),
        GoRoute(
          path: '/admin/notifications',
          pageBuilder: (context, state) =>
              _noTransition(const NotificationsScreen(), state),
        ),
        GoRoute(
          path: '/admin/tv',
          pageBuilder: (context, state) =>
              _noTransition(const TvControlScreen(), state),
        ),
        GoRoute(
          path: '/admin/settings',
          pageBuilder: (context, state) =>
              _noTransition(const SettingsScreen(), state),
        ),
      ],
    ),
  ],
