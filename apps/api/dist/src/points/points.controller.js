...
let PointsController = class PointsController {
    ...
    getHistory(user, take, skip) {
        return this.pointsService.getHistory(user.studentId, take ? parseInt(take) : 50, skip ? parseInt(skip) : 0);
    }
};
exports.PointsController = PointsController;
__decorate([
    (0, roles_decorator_1.Roles)(client_1.UserRole.STUDENT),
    (0, common_1.Get)('student/points'),
...
__decorate([
    (0, roles_decorator_1.Roles)(client_1.UserRole.STUDENT),
    (0, common_1.Get)('student/points/history'),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
