...
const NAV = [
  ...
  { href: "/ops", label: "오늘 운영", icon: ListChecks },
  { href: "/focus", label: "집중 관제", icon: Focus },
  { href: "/parents", label: "학부모 CRM", icon: HeartHandshake },
  { href: "/insights/risks", label: "위험 학생", icon: ShieldAlert },
  { href: "/retention", label: "리텐션", icon: Target },
  { href: "/director/overview", label: "원장 대시보드", icon: Building2 },
    ...
    <aside className="hidden md:flex w-[240px] flex-col bg-white border-r border-card-border shrink-0">
      ...
      <div className="px-6 py-7">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <p className="text-[15px] font-extrabold text-text-primary tracking-tight">
              자습ON
            </p>
      ...
      <nav className="flex-1 px-3 py-4 overflow-y-auto">
        <p className="px-3 text-[10px] font-bold text-text-tertiary tracking-widest uppercase mb-2">
          메뉴
        </p>
